...
class Reader:
    ...
    def start(self) -> None:
        location_id_example = 1

        self._crud.add_device("dev1", "test 1", location_id_example)
        self._crud.add_device("dev2", "test 2", location_id_example)
        self._crud.add_device("dev3", "test 3", location_id_example)
